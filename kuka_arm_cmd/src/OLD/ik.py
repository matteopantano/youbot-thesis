...
from pykdl_utils.kdl_parser import kdl_tree_from_urdf_model # stessa libreria di seguito
from pykdl_utils.kdl_kinematics import KDLKinematics # 	problema qui, necessario integrare wiki.ros.org/pykdl_utils
...
class YoubotArm:
    ...
    def __init__(self):
        ...
        self.kin_grasp = KDLKinematics(youbot_urdf, "base_footprint", "gripper_palm_link") # mancanza dependecies di sopra
    ...
    def grasp_routine(self):
        ...
        q_ik = self.kin_grasp.inverse(pose_above_grasp, jointGuessForGrasp)
